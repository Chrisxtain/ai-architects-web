    ...
    <Layout>
      <div className="section-padding">
        <div className="container-ai max-w-4xl">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-6 sm:mb-8 text-gradient">Privacy Policy</h1>
          <div className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4">Information Sharing</h2>
              <p className="text-muted-foreground mb-4">
